...
export const projects: Project[] = [
  {
    ...
    media: [
      {
        src: video("desktop-customer-service-page.mp4"),
        layout: "desktop",
      ...
      {
        src: video("mobile-carousels.mp4"),
        layout: "mobile",
      ...
      {
        src: video("mobile-customer-selection.mp4"),
        layout: "mobile",
    ...
    highlights: [
      "Designed the backend APIs that hot-swap ML models so we could A/B personalization against our deflection metric.",
      "Shipped two revamps — landing-page personalization and predictive issue selection — steering customers to faster resolutions.",
    ],
  ...
  },
  {
    ...
    media: [
      {
        src: video("mobile-free-text.mp4"),
        layout: "mobile",
    ...
    highlights: [
      "Built a Lambda that calls our LLM service to propose a real-time solution from the free-text box, gated by API Gateway.",
      "Led an unauthenticated flow end-to-end so customers resolve common issues before hitting a login wall.",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Building the AI agent layer — background + foreground agents powered by Claude.",
      "Headed toward a custom MCP server so agents can act on live deal data.",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Surveyed friends' pain points and designed the product directly around them.",
